...
public class output4 extends JFrame implements ActionListener {
	JButton b,btnPrevention;
	JLabel label1;
	output4() {
		Container container=getContentPane();
		container.setLayout(new BorderLayout());
		ImageIcon pic1 = new ImageIcon(new ImageIcon("diseases/white_tip_nematode.jpg").getImage().getScaledInstance(200, 150, java.awt.Image.SCALE_SMOOTH));
		...
		JLabel data1=new JLabel("စပါးရြက္ဖ်ားျဖဴ နီမတုတ္ေရာဂါ");
