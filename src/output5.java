...
public class output5 extends JFrame implements ActionListener {
	...
	output5() {
		...
		ImageIcon pic2 = new ImageIcon(new ImageIcon("diseases/rice_root_knot_nematode.jpg").getImage().getScaledInstance(200, 150, java.awt.Image.SCALE_SMOOTH));
		ImageIcon pic3 = new ImageIcon(new ImageIcon("diseases/white_tip_nematode.jpg").getImage().getScaledInstance(200, 150, java.awt.Image.SCALE_SMOOTH));
